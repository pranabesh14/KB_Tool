...
2. Pull relevant short-term context from ConversationEntityMemory.
3. Pull long-term cached Q&A from qa_memory.
4. Build source-typed prompts (video-only / KB-only) and invoke the LLM.
5. Return a dict {"video": str, "kb": str}.
